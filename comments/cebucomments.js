...
function updateCommentCount() {
    ...
    const comments = JSON.parse(localStorage.getItem('cebucomments')) || [];
...
function addComment() {
    ...
    if (backgroundInput.files && backgroundInput.files[0] && userLocation && commentText) {
        ...
        reader.onload = function (e) {
            ...
            let comments = JSON.parse(localStorage.getItem('cebucomments')) || [];
            comments.push(newComment);
            localStorage.setItem('cebucomments', JSON.stringify(comments));
