...
function addComment() {
    ...
    if (backgroundInput.files && backgroundInput.files[0] && userLocation && commentText) {
        ...
        reader.onload = function (e) {
            ...
            let comments = JSON.parse(localStorage.getItem('comment2')) || [];
...
function editComment(timestamp) {
    const comments = JSON.parse(localStorage.getItem('comment2')) || [];
...
window.addEventListener('load', function() {
    const threadAdd = JSON.parse(localStorage.getItem('threadAdd2')) || [];
